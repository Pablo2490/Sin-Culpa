...
11. Funcionalidad esperada:

Interactividad completa: La página debe permitir al usuario ver productos, añadirlos al carrito, editar el carrito, y simular la compra.

Formulario de contacto: Implementa un formulario funcional que envíe datos a través de Formspree.

Diseño responsivo: Asegúrate de que el diseño sea adaptable a diferentes tamaños de pantalla.

Persistencia del carrito: El carrito debe mantenerse activo incluso si el usuario cierra o actualiza la página, usando localStorage o sessionStorage.
---------------------------------------------------------------------------------------------------------------------------------------

Mi nombre es Pablo Buttazzoni y quiero darles la bienvenida a "Sin Culpa", mi proyecto E-Commerce. La idea a grandes rasgos es crear un sitio inspirado en Mercado Libre, donde la gente pueda buscar y comprar sus productos. En el archivo PDF: "Briefing Ejecutivo de "Sin Culpa"" se ahonda en mas detalle respecto a los elementos especificos de preparacion y maquetacion de la web.